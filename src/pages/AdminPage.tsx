          ...
          {profile?.role === 'owner' || profile?.role === 'admin' ? (
             ...
             <div className="bg-surface-container-low p-8 rounded-2xl border border-white/5">
                <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4">
                  ...
                  <div><h3 className="font-headline font-black text-3xl uppercase italic">Profile</h3></div>
                </div>
             </div>
          )}

          <div className="bg-surface-container-low p-8 rounded-2xl border border-white/5 mt-8">
